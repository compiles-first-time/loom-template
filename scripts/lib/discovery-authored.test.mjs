#!/usr/bin/env node
// BR_08 — discovery-authored doctor check (lesson 2026-07-10).
...
import { BR_08_CASES } from "../../observability/eval-suite/requirements/BR_08.cases.mjs";
...
console.log("\nBR_08 — discovery-authored doctor check");
for (const c of BR_08_CASES) {
  let actual = "";
  let ok = false;
  ...
  emitTestCase({
    id: c.id, parent_id: c.id === "BR_08" ? null : "BR_08", type: c.type,
