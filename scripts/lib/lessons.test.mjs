#!/usr/bin/env node
// BR_10 — lessons-service Phase 0 (ADR-0055).
...
import { BR_10_CASES } from "../../observability/eval-suite/requirements/BR_10.cases.mjs";
...
for (const c of BR_10_CASES) {
  ...
  emitTestCase({
    id: c.id, parent_id: c.id === "BR_10" ? null : "BR_10", type: c.type,
